...
<style>
	...
	.content-inner .content-back {
		...
		background: #292929;
		background-image: url("https://images.unsplash.com/photo-1572284795851-e2c9da37db05?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=967&q=80");
	}
	.content-front {
		background: #292929;
		position: relative;
